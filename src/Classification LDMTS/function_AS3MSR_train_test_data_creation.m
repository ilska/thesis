...
function function_AS3MSR_train_test_data_creation( load_files_path )


save_data_path = strcat(load_files_path,'AS3\train_test_data\');
...
%  {[6 14 15 16 17 18 19 20]}
    if (action == 6 || action == 14 || action == 15 || action == 16  || action == 17 || action == 18 || action == 19 || action ==  20 )
        if (subject == '1')
