function final_results = function_Florence_LDMLTS_classif_and_save( path_origin , outpath,tripletsfactor,cycle,alphafactor)
...
str2crop = path_origin(1,k+10:end-17);
