...
outpath = 'C:\Ira\Results_Master\MSRAction3D\AS1\';
% mkdir(outpath);
%training params
...
%     in_path = strcat(folders_path,nameFolds{i},'\AS1\train_test_data\');
...
%         final_in_path = strcat(in_path,nameFolds2{j},'\AS1\train_test_data\');
