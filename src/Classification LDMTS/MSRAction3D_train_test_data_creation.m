...
master_path = 'C:\Users\ilska\Box Sync\Thesis Experiments\Data_Master\MSRAction3D\'
...
for i = 1:size(nameFolds,1)
    ...
    function_MSR_train_test_data_creation( in_path );
...
for i = 1:size(nameFolds,1)
    ...
    for j=1:size(nameFolds2,1)
        ...
        function_MSR_train_test_data_creation( final_in_path );
    end
end
