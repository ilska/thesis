function stats = confusionmatStats(group,grouphat,All_distances,Distance_2closest_class)
% INPUT
...
[TP,TN,FP,FN,sensitivity,specificity,precision,f_score,acc] = deal(zeros(numOfClasses,1));
...
%     acc(class) = (TP(class) + TN(class))/(TP(class) + FP(class) + FN(class) + TN(class)) ;
end

field2 = 'accuracy';  value2 = sum(TP(:))/totalSamples;
...
field8 = 'mean_accuracy'; value8 = mean(value2);
field9 = 'mean_sensitivity'; value9 = mean(sensitivity);
field10 = 'mean_specificity'; value10 = mean(specificity);
field11 = 'mean_precision'; value11 = mean(precision);
field12 = 'mean_recall'; value12 = mean(sensitivity);
field13 = 'mean_Fscore'; value13 = mean(f_score);
stats = struct(field1,value1,field2,value2,field3,value3,field4,value4,field5,value5,field6,value6,field7,value7,field8,value8,field9,value9,field10,value10, field11,value11,field12,value12,field13,value13,'All_distances',All_distances,'Distance_2closest_class',Distance_2closest_class);
