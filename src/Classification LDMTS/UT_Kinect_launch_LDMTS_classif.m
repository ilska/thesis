...
for i = 1:size(nameFolds,1)
    ...
    statistics_cell = function_UT_LDMLTS_classif_and_save( in_path , outpath,tripletsfactor,cycle,alphafactor);
...
for i = 1:size(nameFolds,1)
    ...
    for j=1:size(nameFolds2,1)
        ...
        statistics_cell = function_UT_LDMLTS_classif_and_save( final_in_path , outpath,tripletsfactor,cycle,alphafactor);
