function [features] = get_absolute_position_features_non_hip_origin(joint_locations, body_model, n_desired_frames)
    ...
    %we transpose this in order to have the features as cols and the frames
    %as rows
    features = features';
end
