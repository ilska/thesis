addpath data
addpath data/Florence3D

dir = 'Florence/Florence_data_0step_original_skel_data/';
    mkdir(dir);
    dir = 'Florence/Florence_data_1step_normalized_2_spine/';
    mkdir(dir);
    dir = 'Florence/Florence_data_2step_normalized_bones_size/';
    mkdir(dir);
    dir = 'Florence/Florence_data_3step_normalized_orientation/';
    mkdir(dir);
    dir = 'Florence/Florence_data_0step_original_skel_data_inter/';
    mkdir(dir);
    dir = 'Florence/Florence_data_1step_normalized_2_spine_inter/';
    mkdir(dir);
    dir = 'Florence/Florence_data_2step_normalized_bones_size_inter/';
    mkdir(dir);
    dir = 'Florence/Florence_data_3step_normalized_orientation_inter/';
    mkdir(dir);
    ...
    n_desired_frames = 35;
        ...
        for i = 1:n_videos
            ...
            % (0,0,0) position of the spine          
             filename = strcat('Florence/Florence_data_0step_original_skel_data/action_a',num2str(unique(action_id(ind))),'_subject_s',num2str(unique(actor_id(ind))), '_i_', num2str(i),'.txt');
             dlmwrite(filename, result_data_original_skel_data,' ');
             filename = strcat('Florence/Florence_data_1step_normalized_2_spine/action_a',num2str(unique(action_id(ind))),'_subject_s',num2str(unique(actor_id(ind))), '_i_', num2str(i),'.txt');
             ...
             filename = strcat('Florence/Florence_data_2step_normalized_bones_size/action_a',num2str(unique(action_id(ind))),'_subject_s',num2str(unique(actor_id(ind))), '_i_', num2str(i),'.txt');                            
             ...
             filename = strcat('Florence/Florence_data_3step_normalized_orientation/action_a',num2str(unique(action_id(ind))),'_subject_s',num2str(unique(actor_id(ind))), '_i_', num2str(i),'.txt');
...
%              %interpolated
            filename = strcat('Florence/Florence_data_0step_original_skel_data_inter/action_a',num2str(unique(action_id(ind))),'_subject_s',num2str(unique(actor_id(ind))), '_i_', num2str(i),'.txt');
            dlmwrite(filename, data_original_skeletal_data_interpolated,' ');
            filename = strcat('Florence/Florence_data_1step_normalized_2_spine_inter/action_a',num2str(unique(action_id(ind))),'_subject_s',num2str(unique(actor_id(ind))), '_i_', num2str(i),'.txt');
            dlmwrite(filename, data_normalized_2_spine_interpolated,' ');
            filename = strcat('Florence/Florence_data_2step_normalized_bones_size_inter/action_a',num2str(unique(action_id(ind))),'_subject_s',num2str(unique(actor_id(ind))), '_i_', num2str(i),'.txt');
            dlmwrite(filename, data_normalized_bones_size_interpolated,' ');
            filename = strcat('Florence/Florence_data_3step_normalized_orientation_inter/action_a',num2str(unique(action_id(ind))),'_subject_s',num2str(unique(actor_id(ind))), '_i_', num2str(i),'.txt');
