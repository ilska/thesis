%% Florence3D, create train_test_sets
clear all
close all
clc

%Load the data from the folder
master_path = 'C:\Users\ilska\Box Sync\Thesis Experiments\Data_Master\Florence\'
...
for i = 1:size(nameFolds,1)
    ...
    function_Florence_train_test_data_creation( in_path );
...
for i = 1:size(nameFolds,1)
    ...
    for j=1:size(nameFolds2,1)
        ...
        function_Florence_train_test_data_creation( final_in_path );
    end
end
...
%     
%     [ subject ] = calc_subject_idx( filename );
%     [ action ] = calc_action_idx( filename,subject );
%     
%      
%         if (subject == '1')
...
% % Option1
% 
% train_data1 = [data_s3 data_s4 data_s5 data_s6 data_s10];
% train_labels1 = [label_s3 label_s4 label_s5 label_s6 label_s10];
% test_data1 = [data_s1 data_s2 data_s7 data_s8 data_s9];
% test_labels1 = [label_s1 label_s2 label_s7 label_s8 label_s9];
% 
...
% %Option 2
% 
% train_data2 = [data_s1 data_s3 data_s5 data_s9 data_s10];
% train_labels2 = [label_s1 label_s3 label_s5 label_s9 label_s10];
% test_data2 = [data_s2 data_s4 data_s6 data_s7 data_s8];
% test_labels2 = [label_s2 label_s4 label_s6 label_s7 label_s8];
% 
...
% %Option 3
% 
% train_data3 = [data_s1 data_s2 data_s4 data_s6 data_s9];
% train_labels3 = [label_s1 label_s2 label_s4 label_s6 label_s9];
% test_data3 = [data_s3 data_s5 data_s7 data_s8 data_s10];
% test_labels3 = [label_s3 label_s5 label_s7 label_s8 label_s10];
% 
...
% %Option 4
% 
% train_data4 = [data_s2 data_s3 data_s6 data_s8 data_s10];
% train_labels4 = [label_s2 label_s3 label_s6 label_s8 label_s10];
% test_data4 = [data_s1 data_s4 data_s5 data_s7 data_s9];
% test_labels4 = [label_s1 label_s4 label_s5 label_s7 label_s9];
% 
...
% 
% %Option 5
% train_data5 = [data_s3 data_s4 data_s6 data_s7 data_s9];
% train_labels5 = [label_s3 label_s4 label_s6 label_s7 label_s9];
% 
% test_data5 = [data_s1 data_s2 data_s5 data_s8 data_s10];
% test_labels5 = [label_s1 label_s2 label_s5 label_s8 label_s10];
% 
...
% 
% %Option 6
% train_data6 = [data_s1 data_s2 data_s6 data_s8 data_s10];
% train_labels6 = [label_s1 label_s2 label_s6 label_s8 label_s10];
% 
% test_data6 = [data_s3 data_s4 data_s5 data_s7 data_s9];
% test_labels6 = [label_s3 label_s4 label_s5 label_s7 label_s9];
% 
...
% 
% %Option 7
% train_data7 = [data_s1 data_s2 data_s6 data_s7 data_s10];
% train_labels7 = [label_s1 label_s2 label_s6 label_s7 label_s10];
% 
% test_data7 = [data_s3 data_s4 data_s5 data_s8 data_s9];
% test_labels7 = [label_s3 label_s4 label_s5 label_s8 label_s9];
% 
...
% 
% %Option 8
% train_data8 = [data_s1 data_s3 data_s5 data_s6 data_s8];
% train_labels8 = [label_s1 label_s3 label_s5 label_s6 label_s8];
% 
% test_data8 = [data_s2 data_s4 data_s7 data_s9 data_s10];
% test_labels8 = [label_s2 label_s4 label_s7 label_s9 label_s10];
% 
...
% 
% %Option 9
% train_data9 = [data_s2 data_s3 data_s6 data_s9 data_s10];
% train_labels9 = [label_s2 label_s3 label_s6 label_s9 label_s10];
% 
% test_data9 = [data_s1 data_s4 data_s5 data_s7 data_s8];
% test_labels9 = [label_s1 label_s4 label_s5 label_s7 label_s8];
% 
...
% 
% %Option 10
% train_data10 = [data_s1 data_s2 data_s6 data_s9 data_s10];
% train_labels10 = [label_s1 label_s2 label_s6 label_s9 label_s10];
% 
% test_data10 = [data_s3 data_s4 data_s5 data_s7 data_s8];
% test_labels10 = [label_s3 label_s4 label_s5 label_s7 label_s8];
% 
