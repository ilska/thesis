function compute_and_save_SAX( load_files_path, destination_path,alphabet_size,nsegments )
...
files = dir(dir_files_path);
 ...
 for file = files'
    ...
    SAX_activity = function_multivariate_ts_SAX( raw_data, alphabet_size,nsegments );
         
    %save
    saving_path = strcat(destination_path,filename);
    dlmwrite(saving_path,SAX_activity, ' '); 
